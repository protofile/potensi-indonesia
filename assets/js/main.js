$(document).ready(function(){
    ...
    $(".close-bt").mousemove(function(e) {
        $('.space-cursor').eq(0).css({'opacity': '1'});
    })
    $(".close-bt").mouseleave(function(e) {
        $('.space-cursor').eq(0).css({'opacity': '0'});
    })
    $(".close-bt").mousemove(function(e) {
        $('.space-cursor-2').eq(0).css({'opacity': '1'});
    })
    $(".close-bt").mouseleave(function(e) {
        $('.space-cursor-2').eq(0).css({'opacity': '0'});
    })*/
